...
export default function App() {
 ...
 <span className="text-base sm:text-base font-bold text-slate-400 font-body">
 ...
 {/* Stars Count Badge */}
 <div className="bg-amber-100 border-2 border-amber-300 text-amber-900 rounded-full py-1.5 px-3 flex items-center gap-1.5 shadow-sm text-base sm:text-lg font-black">
 ...
 <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-emerald-500 text-sm text-white font-black items-center justify-center">✓</span>
 </span>
 )}
 </button>
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 hover:bg-slate-100 text-slate-500 transition-colors text-base sm:text-lg font-bold font-body cursor-pointer"
 >
 <ArrowLeft className="w-4 h-4" /> Karte
 </button>

 <div className="text-center font-sans">
 <span className="text-base font-bold text-[#00639a] block leading-none">
 Klasse {activeStation?.grade} Abenteuer
 </span>
 <span className="text-lg font-extrabold text-slate-800 truncate block mt-0.5 max-w-[180px] sm:max-w-none">
 {activeStation?.title}
 </span>
 </div>

 {/* Round Mini Level Tracker Progress Circle */}
 <div className="text-base font-bold text-slate-400 bg-slate-100/80 px-2.5 py-1 rounded-full">
 ...
 <div className="space-y-1.5">
 <span className="text-base font-black text-amber-600 block font-sans">
 Station gemeistert!
 </span>
 ...
 <p className="text-lg font-semibold text-slate-500 font-body leading-relaxed">
