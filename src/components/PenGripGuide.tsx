...
export default function PenGripGuide() {
 ...
 <span className="font-sans font-black text-base sm:text-lg ">
 ...
 {/* Headline for kids */}
 <h4 className="text-lg sm:text-base font-extrabold text-indigo-950">
 ...
 <div className="bg-indigo-50/50 p-3 rounded-2xl border border-indigo-100 text-base sm:text-lg font-extrabold text-indigo-900 leading-snug">
