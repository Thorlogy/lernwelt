...
export default function StationWordTypes({
 ...
 <p className="text-base sm:text-lg text-brand-secondary font-extrabold mt-1">
 ...
 <span className="text-base sm:text-lg font-extrabold text-amber-800 block mb-1">
 Gesuchtes Wort
 </span>
 ...
 <span className="text-base text-amber-800 font-extrabold mt-1 bg-amber-200/50 px-2 py-0.5 rounded-lg">
 Namenwort
 </span>
 <span className="text-base font-bold text-slate-700 mt-3 leading-relaxed text-center">
 Hund, Baum, Haus<br/>
 <span className="text-base text-amber-800 font-extrabold bg-amber-200/30 px-1.5 py-0.5 rounded-md border border-amber-300/40 inline-block mt-1.5">
 Groß geschrieben!
 </span>
 </span>
 </button>
 ...
 <span className="text-base text-emerald-800 font-extrabold mt-1 bg-emerald-200/50 px-2 py-0.5 rounded-lg">
 Tuwort
 </span>
 <span className="text-base font-bold text-slate-700 mt-3 leading-relaxed text-center">
 rennen, essen, spielen<br/>
 <span className="text-base text-emerald-800 font-extrabold bg-emerald-200/30 px-1.5 py-0.5 rounded-md border border-emerald-300/40 inline-block mt-1.5">
 Klein geschrieben
 </span>
 </span>
 </button>
 ...
 <span className="text-base text-sky-800 font-extrabold mt-1 bg-sky-200/50 px-2 py-0.5 rounded-lg">
 Wiewort
 </span>
 <span className="text-base font-bold text-slate-700 mt-3 leading-relaxed text-center">
 schnell, bunt, klug<br/>
 <span className="text-base text-sky-800 font-extrabold bg-sky-200/30 px-1.5 py-0.5 rounded-md border border-sky-300/40 inline-block mt-1.5">
 Wie ist eine Sache?
 </span>
 </span>
 </button>
 ...
 onClick={handleCheck}
 className={`px-6 py-2.5 rounded-xl text-base sm:text-lg font-extrabold shadow-md flex items-center gap-1.5 cursor-pointer ${
 selectedCategory
