...
export default function StationSpellingDetective({
 ...
 <SpeakButton text={exercise.sentenceWithMistakes} size={24} label="Satz vorlesen" />
 </h3>
 ...
 <div className="text-base text-slate-400 font-extrabold mb-4 font-sans block">
 ...
 <p className="text-lg text-slate-500 font-semibold font-body">
 Hast du das falsche Wort gefunden? Klicke auf "Prüfen".
 </p>
 <button
 onClick={handleVerifyMistakeWord}
 className="btn-tactile-secondary text-[#725c00] text-lg font-extrabold px-6 py-2.5 rounded-xl shadow-md cursor-pointer"
 >
 Das hier ist falsch! 🔎
 </button>
 </div>
 ) : (
 <p className="text-base text-slate-400 py-3 font-semibold font-body">
 ...
 <p className="text-base text-slate-500 font-medium font-body mt-1">
 ...
 className={`px-5 py-2 rounded-xl text-base sm:text-lg font-extrabold cursor-pointer border-b-4 transition-all duration-100 ${
