...
export default function StationMathFractions({
 ...
 <p className="text-lg font-extrabold text-[#00639a] font-body text-center">
 ...
 <div className="flex p-0.5 bg-slate-100 rounded-xl border border-slate-200 text-base font-bold font-body">
 <button
 type="button"
 ...
 <span className="text-base font-bold text-orange-700 block mb-1 font-sans">
 Bruch-Bauaufgabe
 </span>
 ...
 <div className="flex justify-between items-center text-base font-extrabold text-slate-500 ">
 <span className="flex items-center gap-1"><Sliders className="w-3.5 h-3.5" /> Aufteilung anpassen</span>
 <span className="bg-slate-200 px-2 py-0.5 rounded-md font-sans text-slate-700 text-base">
 ...
 {/* Status Bar */}
 <div className="text-center font-bold text-lg text-slate-600 mb-6 bg-slate-50 p-2 rounded-xl border max-w-xs mx-auto font-body">
 ...
 className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl border border-slate-300 text-slate-500 hover:text-orange-600 hover:bg-orange-50 hover:border-orange-300 transition-colors cursor-pointer text-base sm:text-lg font-bold font-body"
 >
 ...
 <button
 onClick={handleCheck}
 className="btn-tactile-secondary text-orange-950 border-b-4 border-yellow-500 px-6 py-2.5 rounded-xl text-lg sm:text-base font-extrabold shadow-md flex items-center gap-1.5 cursor-pointer"
 >
 Überprüfen! 🎯
 </button>
 ) : isCorrect === true ? (
