  ...
  return (
    <div className={`bg-white rounded-3xl p-6 shadow-high-tactile border border-slate-100 max-w-xl mx-auto ${shakeTrigger ? 'animate-shake' : ''}`}>
      ...
      <div className="bg-gradient-to-r from-emerald-50 via-teal-50 to-emerald-50 p-6 rounded-2xl border-2 border-emerald-200 shadow-sm text-center mb-8 relative">
        <span className="text-xs font-bold text-emerald-700 uppercase tracking-widest block mb-3 font-sans">
          Satz ergänzen
        </span>
        
        {renderSentenceWithGap()}

        <span className="inline-block mt-4 bg-emerald-100/60 text-emerald-800 text-xs font-bold px-3 py-1 rounded-full border border-emerald-200 font-sans">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl border border-slate-300 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 hover:border-emerald-300 transition-colors cursor-pointer text-xs sm:text-sm font-bold font-body"
          >
        ...
        {showHint && (
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-xs sm:text-sm text-emerald-900 leading-relaxed font-semibold">
