...
export default function ResearchDashboard({
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 hover:bg-slate-100 text-slate-500 transition-colors text-base font-bold cursor-pointer"
 >
 ...
 <span className="bg-emerald-100 text-emerald-800 text-base font-black px-2.5 py-1 rounded-full flex items-center gap-1">
 <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-ping"></span> Cloud Live
 </span>
 </div>

 {/* Cloud Status Banner */}
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-slate-50 p-4 rounded-2xl border border-slate-200/60 gap-3 text-base sm:text-lg text-slate-600 font-body">
 <div>
 ...
 <span className="text-base">{totalSubmissions} Aufgaben gesamt</span>
 </div>
 </div>
 ...
 <p className="text-base font-bold text-slate-400 font-sans">
 Lade Cloud-Metriken...
 </p>
 </div>
 ) : (
 ...
 <p className="text-base text-blue-800 font-bold ">Zwanzigerfeld & Pizza</p>
 
 <div className="grid grid-cols-3 gap-2 text-center pt-2">
 <div className="bg-white p-2 rounded-xl shadow-xs">
 <span className="text-slate-400 text-sm font-bold block leading-none">GELÖST</span>
 <span className="text-base font-black text-slate-800 mt-1 block">{statsA.answered}</span>
 </div>
 <div className="bg-white p-2 rounded-xl shadow-xs">
 <span className="text-slate-400 text-sm font-bold block leading-none">1. VERSUCH</span>
 <span className="text-base font-black text-blue-700 mt-1 block">{statsA.firstTryRate}%</span>
 </div>
 <div className="bg-white p-2 rounded-xl shadow-xs">
 <span className="text-slate-400 text-sm font-bold block leading-none">ZEIT/AUFG.</span>
 <span className="text-base font-black text-slate-800 mt-1 block">{statsA.avgTime}s</span>
 </div>
 </div>

 <div className="bg-white/80 p-3 rounded-xl border border-blue-100 text-base font-semibold text-blue-950 font-body">
 ...
 <p className="text-base text-emerald-800 font-bold ">Balken & Zahlbeziehungen</p>
 ...
 <div className="bg-white/80 p-3 rounded-xl border border-emerald-100 text-base font-semibold text-emerald-950 font-body">
 ...
 <h3 className="font-sans font-extrabold text-lg text-yellow-900 flex items-center gap-1.5">
 <Award className="w-4 h-4 text-yellow-700" />
 <span>Didaktische Empfehlung & Auswertung</span>
 </h3>
 <p className="text-base sm:text-lg text-yellow-950 leading-relaxed font-semibold font-body">
 {getRecommendation()}
 </p>
 </div>
 </>
 ...
 <h4 className="font-sans font-extrabold text-base text-slate-500 flex items-center gap-1">
 <Zap className="w-3.5 h-3.5 text-[#00639a]" /> State-of-the-Art Forschung
 </h4>
 <div className="text-base text-slate-600 leading-relaxed font-body space-y-2.5">
 <p>
 ...
 className="text-[#00639a] hover:text-[#004e76] hover:bg-slate-50 text-base font-black px-2.5 py-1.5 rounded-xl border border-dashed border-slate-200 flex items-center gap-1.5 transition-colors cursor-pointer"
 >
 ...
 <button
 onClick={() => { playPop(); onClose(); }}
 className="btn-tactile-primary text-white text-base font-black px-5 py-2.5 rounded-xl cursor-pointer"
 >
 Zurück zum Spiel
 </button>
 </div>
