...
export default function StationMathQuiz({
 ...
 <span className="text-base font-extrabold text-slate-400 block mb-2 font-sans text-center">
 ...
 <span className="text-red-500 font-black text-base select-none">❌</span>
 )}
 </div>
 );
 })}
 ...
 <div className="flex justify-center gap-4 mt-2.5 text-base font-bold text-slate-500 font-body">
 ...
 <text x="50" y="24" textAnchor="middle" className="text-sm font-black fill-indigo-900 font-sans">{wholeLabel}</text>
 <text x="50" y="5" textAnchor="middle" className="text-[5px] font-bold fill-slate-400 font-sans">Ganzes</text>

 <circle cx="25" cy="60" r="11" className="fill-amber-50 stroke-amber-500 stroke-2" />
 <text x="25" y="63.5" textAnchor="middle" className="text-sm font-bold fill-amber-900 font-sans">{part1Label}</text>
 <text x="25" y="78" textAnchor="middle" className="text-[5px] font-bold fill-slate-400 font-sans">Teil 1</text>

 <circle cx="75" cy="60" r="11" className="fill-blue-50 stroke-blue-500 stroke-2" />
 <text x="75" y="63.5" textAnchor="middle" className="text-sm font-bold fill-blue-900 font-sans">{part2Label}</text>
 <text x="75" y="78" textAnchor="middle" className="text-[5px] font-bold fill-slate-400 font-sans">Teil 2</text>
 </svg>
 </div>
 </div>
 );
 ...
 <div className="flex items-center justify-between text-base font-extrabold text-slate-400 ">
 ...
 <label className="btn-tactile-outline bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 px-5 py-3 rounded-2xl flex items-center gap-2 cursor-pointer text-base font-black select-none">
 ...
 <p className="text-sm text-slate-400 font-semibold mt-2 max-w-[240px] leading-snug">
 ...
 return (
 <div className="mt-4 p-4 bg-slate-50 rounded-2xl border-2 border-slate-200/80 max-w-sm mx-auto">
 <span className="text-base font-extrabold text-slate-400 block mb-3 font-sans text-center">
 ...
 <div
 key={idx}
 className="flex-1 bg-emerald-100/50 border-r last:border-r-0 border-emerald-700 flex items-center justify-center font-black text-emerald-800 text-lg font-sans"
 >
 {val}
 </div>
 ))}
 ...
 <span className="text-base font-black text-slate-700 mt-1 font-sans">
 ...
 <span className="text-base font-extrabold text-slate-400 block font-sans">
 🥧 Interaktives Aufteilen in der Familie
 </span>

 {/* 1. People count selector */}
 <div className="space-y-1.5">
 <p className="text-[11px] font-extrabold text-slate-500 ">Ich möchte gerecht teilen:</p>
 ...
 className={`px-3 py-1.5 rounded-xl border text-base sm:text-base font-black cursor-pointer transition-all ${
 familyCount === btn.val
 ...
 >
 <span className="text-base font-black text-slate-400 block mb-1">
 Korb {bIdx + 1}
 </span>
 ...
 <span className="text-base font-extrabold text-[#00639a] block mb-4">
 ...
 let coinStyle = "";
 if (coin.isBill) {
 coinStyle = `w-18 h-10 bg-blue-100 border-2 text-blue-900 font-extrabold text-base rounded-lg flex items-center justify-center ${
 isSelected 
 ...
 coinStyle = `w-12 h-12 rounded-full font-black text-lg flex items-center justify-center border-2 ${
 coin.label === '2 €' 
 ...
 const size = coin.label === '50c' ? 'w-10 h-10 text-base' : coin.label === '20c' ? 'w-9 h-9 text-sm' : 'w-8.5 h-8.5 text-sm';
 ...
 <span className="text-base font-bold text-slate-500">Dein gewählter Betrag:</span>
 ...
 <div className="text-left font-bold text-base text-slate-700 leading-tight">
 Mehl: 500 g<br/>
 Zucker: 250 g
 </div>
 </div>
 ...
 <span className="text-base font-bold text-slate-500">Lineal: 30 cm • Heft: 20 cm</span>
 </div>
 );
 } else {
 ...
 <span className="text-base font-extrabold text-slate-400 block mb-2">
 {illustrationText}
 </span>
 ...
 <p className="text-base font-extrabold text-slate-400 mt-0.5">
 Metakognition & Reflexion
 </p>
 </div>

 {/* Question Prompt (increased font size) */}
 <div className="bg-indigo-50 border-2 border-indigo-100 p-5 rounded-2xl text-lg sm:text-base text-indigo-950 font-black leading-relaxed font-body">
 {sDetails.question}
 </div>
 ...
 className={`w-full text-left p-4 rounded-2xl border-2 text-lg sm:text-base font-extrabold transition-all cursor-pointer font-body leading-relaxed flex items-start gap-2.5 ${btnStyle}`}
 >
 ...
 <div className="bg-slate-50 border p-4 rounded-2xl text-lg sm:text-base text-slate-800 leading-relaxed font-extrabold font-body">
 ...
 className={`px-7 py-3 rounded-xl text-lg sm:text-base font-extrabold shadow-md ${
 ...
 className="btn-tactile-primary text-white px-8 py-3.5 rounded-xl text-lg sm:text-base font-black flex items-center gap-2 cursor-pointer shadow-lg hover:brightness-105"
 >
 ...
 <div className="flex p-0.5 bg-slate-100 rounded-xl border border-slate-200 text-base font-bold">
 <button
 type="button"
 ...
 className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl border border-slate-300 text-slate-500 hover:text-cyan-600 hover:bg-cyan-50 hover:border-cyan-300 transition-colors cursor-pointer text-base sm:text-lg font-bold font-body"
 >
 ...
 {showHint && (
 <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-3 text-base sm:text-lg text-cyan-950 leading-relaxed font-semibold">
